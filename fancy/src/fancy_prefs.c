 ...
 * == Fancy Plugin ==
 * This file Copyright (C) 2008 Salvatore De Paolis
...
static PrefParam param[] = {
        {"auto_load_images", "FALSE", &fancy_prefs.auto_load_images, P_BOOL, NULL, NULL, NULL},
        {"block_links", "FALSE", &fancy_prefs.block_links, P_BOOL, NULL, NULL, NULL},
        {"enable_scripts", "FALSE", &fancy_prefs.enable_scripts, P_BOOL, NULL, NULL, NULL},
        {"enable_plugins", "FALSE", &fancy_prefs.enable_plugins, P_BOOL, NULL, NULL, NULL},
        {0,0,0,0}
};

static FancyPrefsPage fancy_prefs_page;

static void create_fancy_prefs_page	(PrefsPage *page,
					 GtkWindow *window,
					 gpointer   data);
...
static void create_fancy_prefs_page(PrefsPage *page, GtkWindow *window, gpointer data)
{
	...
	checkbox1 = gtk_check_button_new_with_label
				(_("Auto-Load images"));
	...
	checkbox2 = gtk_check_button_new_with_label
				(_("Block external links"));
	...
	checkbox3 = gtk_check_button_new_with_label
				(_("Enable Javascript"));
	...
	checkbox4 = gtk_check_button_new_with_label
				(_("Enable Plugins"));
