...
(note that with recent versions of Sylpheed-Claws, this script might not
work due to upstream synthax changes. This will get updated in the
...
The messages are logged in Sylpheed-Claws' log window.
...
line. Make sure Sylpheed-Claws is not running while you do
this.
